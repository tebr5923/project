...
public class CardTransferControllerExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(CardTransferNotFoundException.class)
    public ResponseEntity<String> handleCardTransferNotFoundException(CardTransferNotFoundException e) {
